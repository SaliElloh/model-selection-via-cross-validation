...
# find the coefficients of the optimal degree:
weights = model.coef_

#print results:

print(f"Test RMSE for optimal degree (6) for all data: {test_rmse:.5f}")
print(f"Train RMSE for optimal degree (6) for all data: {train_rmse:.5f}")
print(f"the weights for the optimal degree (6) are: \n{weights}")
...
# Use the trained Ridge regression model with the optimal lambda value d∗ to predict the y values for the transformed x-axis
